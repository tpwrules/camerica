...
# Memory: nios_program
MEM_0 := soc_system_nios_program
$(MEM_0)_NAME := nios_program
...
$(MEM_0)_END := 0x000107ff
$(MEM_0)_SPAN := 0x00000800
$(MEM_0)_HIERARCHICAL_PATH := nios_program
$(MEM_0)_WIDTH := 32
...
.PHONY: nios_program
nios_program: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
